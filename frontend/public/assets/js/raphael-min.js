...
//             u.percent != e ? (ic.splice(v, 1), (k = 1)) : (j = u),
...
//         !(fb[z](a.toLowerCase().substring(0, 2)) || "#" == a.charAt()) &&
//           (a = ub(a));
//         var b,
//           d,
//           e,
...
//             if (!b[d].offset) {
//               for (
//                 var h = _(b[d - 1].offset || 0), i = 0, j = d + 1;
//                 e > j;
//                 j++
//               )
//                 if (b[j].offset) {
...
//         return (
//           null == a ? (kb[this.id] = {}) : kb[this.id] && delete kb[this.id][a],
//           this
//         );
//       }),
//       ($b.getData = function () {
...
//             else {
//               if (
//                 ((j = cc(g, h, i[1], i[2], i[3], i[4], i[5], i[6])), n + j > e)
//               ) {
//                 if (b && !m.start) {
//                   if (
...
//         return a == !!a
//           ? a
//           : R(2, -10 * a) * N.sin(((a - 0.075) * 2 * S) / 0.3) + 1;
//       },
//       bounce: function (a) {
//         var b,
//           c = 7.5625,
...
//                           B = q("rect");
//                         (A.id = c.createUUID()),
//                           q(B, { x: z[0], y: z[1], width: z[2], height: z[3] }),
//                           A.appendChild(B),
...
//                 }
//                 i["clip-rect"] ||
//                   (l.clipRect && (l.clipRect.style.clip = "auto"));
//               }
//               if (e.textpath) {
...
//               e &&
//                 (d = a = b(a).replace(/\.{3}|\u2026/g, this._.transform || o)),
...
//                   return this.attrs.gradient;
//                 for (
//                   var g = b.split(k), h = {}, i = 0, m = g.length;
//                   m > i;
//                   i++
//                 )
//                   (b = g[i]),
...
//               var f = F("skew");
//               return (
//                 (f.on = !0), c.appendChild(f), (d.skew = f), d.transform(o), d
//               );
//             }),
...
//               var m = F("skew");
//               return (
//                 (m.on = !0), h.appendChild(m), (k.skew = m), k.transform(o), k
//               );
//             }),
//             (c._engine.setSize = function (a, b) {
