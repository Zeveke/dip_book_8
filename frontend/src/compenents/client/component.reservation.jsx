            ...
            <div key={room._id} className="card bg-white rounded overflow-hidden mb-4">
              <div className="row">
                <div className="col-md-2 p-0">
                  <img src={`http://217.25.90.141:3005${room.image[0]}`} className="img-fluid h-100 w-100" alt="" />
                </div>
                ...
                <Carousel>
                  {selectedRoom.image.map((image, index) => (
                    <Carousel.Item key={index}>
                      <img className="d-block w-100" src={`http://217.25.90.141:3005${image}`} alt={`Slide ${index}`} />
                    </Carousel.Item>
                  ))}
                </Carousel>
